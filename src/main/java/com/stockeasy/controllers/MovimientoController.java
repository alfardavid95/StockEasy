...
public class MovimientoController {
    ...
    @GetMapping("/listado") public String listado(@RequestParam(required=false) String texto, @RequestParam(required=false) String tipo, Model model){ model.addAttribute("movimientos", movimientoService.getMovimientos(texto,tipo)); return "movimiento/listado"; }
